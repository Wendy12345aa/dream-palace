# Sprint 2.4 - Character & Narrative Lock

## Objective

Lock the identity, naming, voice, relationship style, and localization philosophy for the Dream Palace companion cast.

Golden rule:

> Players should fall in love with the companions, not admire the writing.

This sprint does not add new gameplay. It makes the existing demo and future production work speak with a stable character foundation.

## Completed Deliverables

- [x] Created `docs/09_Localization_Bible.md`.
- [x] Updated `docs/04_Character_Bible.md` with official companion identity, naming, and voice locks.
- [x] Updated `ROADMAP.md` to mark Character & Narrative Lock complete.
- [x] Updated current demo display names from internal IDs to official companion names.
...
Sprint 2.4 is complete when future dialogue, CG, portraits, audio, animation, UI, and localization can use `docs/04_Character_Bible.md` and `docs/09_Localization_Bible.md` as the stable narrative source.

The current demo now uses official display names in the player-facing UI while keeping internal IDs unchanged for implementation and assets.
